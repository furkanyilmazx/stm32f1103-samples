...
//---------------------------------------------------------------------------------------------------------------------------------------													
#define AD5932_SIN_OUT 			(uint16_t)0x0600	// Control register da cikisin sinus olmasini isteniyorsa AD5932_CR_base ile "or" lanir. DAC enable
...
#define twoPow24	(uint32_t)0x01000000
#define mCLK50mhz	(uint32_t)0x02FAF080
...
void 	init_RCC_AD5932(void);
void 	sendByte_USART(uint8_t data);
void 	sendString_USART(const char data[]);
void 	init_SPI_for_AD5932(void);
void	init_TIM_for_AD5932(void);
void	init_NVIC_for_TIM(void);
void 	init_USART_for_AD5932(void);
void	init_ADC_for_AD5932(void);

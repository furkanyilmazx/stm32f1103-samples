...
{  
  ...
  I2C_Send7bitAddress(I2C1, sEEAddress, I2C_Direction_Transmitter);
  ...
  I2C_Send7bitAddress(I2C1, sEEAddress, I2C_Direction_Receiver);  
  ...
  else/* More than one Byte Master Reception procedure (DMA) -----------------*/
  {
    ...
    sEEDMA_InitStructure.DMA_BufferSize = (uint32_t)(*NumByteToRead);      
...
{ 
  ...
  /* Configure the DMA Tx Channel with the buffer address and the buffer size */
    ...
    sEEDMA_InitStructure.DMA_BufferSize = (uint8_t)(*NumByteToWrite);  
